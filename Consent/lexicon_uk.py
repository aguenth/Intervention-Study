class Lexicon:
    ...
    mobile = "Sorry, this experiment does not allow mobile browsers. Please return to the Prolific website and paste this code: C12QBOS2"
    next = "Next"
    ...
    consent_p10 = 'If you want to participate, you need to check the boxes below and click next. <b>If you do not want to participate, simply close this window.</b>  </p> <p> Based on the information presented above, I confirm that I wish to take part in this study and I authorise:'
