class Lexicon:
    ...
    consent_p4 = 'There are no known risks associated with your participation in this research beyond those of everyday life. You  will be incentivized by the market research institute for taking part in this study. Your participation  may help to better understand open research questions in behavioral and environmental psychology.'

    privacy = 'Data Protection and Anonymity:'
    consent_p5 = ' Confidentiality of your data records will be strictly maintained by assigning ids to each participant so that data is never directly linked to individual identity. No one, including the researchers of this study,  will be able to reveal your identity. The data will be made available in an anonymized form on Open Science platforms. All sensitive information that could potentially be used to reveal your identity (including your anonymous participant code) will be removed from the dataset prior to publishing the data.  We, the researchers on the project, will also never know the identity of any of the participants.'

    consent_p6 = '<b>Participation in this study is voluntary. You may refuse to participate or withdraw at any time without penalty.</b> '
    ...
    data_consent2 = 'The use of the data for teaching purposes (courses and lectures for students and professionals subject to professional confi