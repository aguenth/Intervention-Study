class Lexicon:
    ...
    risk_intro = "Please answer the questions below."
    ...
    cc_concern1_label = "I worry about the climate´s state."
    cc_concern2_label = "Climate protection is important for our future."
    cc_concern3_label = "We must protect the climate´s delicate equilibrium."
