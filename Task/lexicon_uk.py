class Lexicon:
    ...
    tax_text = "The policy package can include a <b>carbon tax on petrol emissions</b>. This tax is expressed in £ per metric ton of CO2. Each litre of petrol burned produces about 2.5 kilograms of CO2, so the carbon tax would increase the price of fuel. As a result, the savings from driving an electric vehicle would be higher compared to a petrol car. The tax revenue would be redistributed to low-income households so that those who cannot afford an electric vehicle but have to rely on their car are not disadvantaged."
