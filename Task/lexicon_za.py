class Lexicon:
    ...
    savings_text = "Charging an electric vehicles is <b>cheaper than fueling a petrol car</b>. Therefore, the costs per mile are lower for electric vehicles than for petrol cars. The savings are calculated by comparing electricity prices with petrol prices and the efficiency of electric vehicles with traditional cars. <b>The value presented tells you how much you can save with this electric car for 100 miles.</b>"
