class Lexicon:
    ...
    savings_text = "Charging an electric vehicles is <b>cheaper than fueling a petrol car</b>. Therefore, the costs per mile are lower for electric vehicles than for petrol cars. The savings are calculated by comparing electricity prices with petrol prices and the efficiency of electric vehicles with traditional cars. <b>The value presented tells you how much you can save with this electric car for every 100 km.</b>"
    emissions_text = "The emissions show the environmental footprint of the electric car <b>in metric tons</b> from the production to its decommissioning after <b>approx. 200,000 km</b>. This includes emissions from production, disposal and the electricity needed for driving."
    range_text = "The battery range indicates the <b>distance an electric vehicle can travel on a single battery charge</b>. It indicates how many km you can drive before you have to stop to charge the battery."
    ...
    tax_text = "The policy package can include a <b>carbon tax on petrol emissions</b>. This tax is expressed in Rand per metric ton of CO2. Each litre of petrol burned produces about 2.5 kilograms of CO2, so the carbon tax would increase the price of fuel. As a result, the savings from driving an electric vehicle would be higher compared to a petrol car. The tax revenue would be redistributed to low-income households so that those who cannot afford an electric vehicle but have to rely on their car are not disadvantaged."
    ...
    label_text = "This attribute describes whether the government plans to introduce a <b>voluntary or mandatory climate label for cars</b>. The climate label provides information about the <b>climate footprint of electric vehicles compared to petrol vehicles</b> and vice versa (i.e. how much less emissions an electric car produces). A climate label is a policy tool to improve consumer awareness and transparency regarding the environmental impact of vehicle choices."
