class Lexicon:
    ...
    savings_text = "Charging an electric vehicles is <b>cheaper than fueling a gasoline car</b>. Therefore, the costs per mile are lower for electric vehicles than for gasoline cars. The savings are calculated by comparing electricity prices with gas prices and the efficiency of electric vehicles with traditional cars. <b>The value presented tells you how much you can save with this electric car for every 100 miles.</b>"
    ...
    tax_text = "The policy package can include a <b>carbon tax on gasoline emissions</b>. This tax is expressed in $ per metric ton of CO2. Each gallon of gasoline burned produces about 9 kilograms of CO2, so the carbon tax would increase the price of fuel. As a result, the savings from driving an electric vehicle would be higher compared to a gasoline car. The tax revenue would be redistributed to mid- and low-income households so that those who cannot afford an electric vehicle but have to rely on their car are not disadvantaged."
    ...
    label_text = "This attribute describes whether the government plans to introduce a <b>voluntary or mandatory climate label for cars</b>. The climate label makes manufacturers provide information about the <b>climate footprint of electric vehicles compared to gasoline vehicles</b> and vice versa (i.e. how much less emissions an electric car produces). A climate label is a policy tool to improve consumer awareness and transparency regarding the environmental impact of vehicle choices."
