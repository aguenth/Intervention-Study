class Lexicon:
    ...
    km_year_label = "How many miles do you drive on average <i>in one year</i>?"
    ...
    affect_ice_title = "Feelings towards petrol cars"
    affect_ice_label = "Overall, how do you feel about petrol or diesel cars?"
